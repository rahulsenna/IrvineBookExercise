...
.data
	aWalk DrunkardWalk <>
	phoneDroppedText BYTE "Phone Dropped!!! -> "
.code
main PROC
...
LOCAL currX:WORD, currY:WORD, droppedPhoneTime:DWORD
;
...
;-------------------------------------------------------
	...
	mov eax,WalkMax
	call RandomRange
	mov droppedPhoneTime,eax

	mov eax,4 ; choose a direction (0-3)
	call RandomRange

Again:
	cmp ecx, droppedPhoneTime
	jne PhoneNotDropped
	mov edx,offset phoneDroppedText
	call WriteString
PhoneNotDropped:
